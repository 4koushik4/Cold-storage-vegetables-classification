...
export const coldStorageVegetables: Record<string, VegetableConfig> = {
  ...
  carrot: { name: "Carrot", coldStorageCrop: true, recommendedStorage: "~0°C" },
  broccoli: { name: "Broccoli", coldStorageCrop: true, recommendedStorage: "0°C" },
  potato: { name: "Potato", coldStorageCrop: true, recommendedStorage: "~4–10°C" },
  ...
  pumpkin: { name: "Pumpkin", coldStorageCrop: true, recommendedStorage: "~12.5–15°C" },
  bean: { name: "Bean", coldStorageCrop: true, recommendedStorage: "~7–10°C" },
  papaya: { name: "Papaya", coldStorageCrop: true, recommendedStorage: "10–13°C" },
  bitterGourd: { name: "Bitter Gourd", coldStorageCrop: true, recommendedStorage: "~10–12.5°C" },
  bottleGourd: { name: "Bottle Gourd", coldStorageCrop: true, recommendedStorage: "~10–12.5°C" },
  brinjal: { name: "Brinjal", coldStorageCrop: true, recommendedStorage: "~10–12.5°C" },
  capsicum: { name: "Capsicum", coldStorageCrop: true, recommendedStorage: "~7–10°C" },
  radish: { name: "Radish", coldStorageCrop: true, recommendedStorage: "~0°C" },
};
