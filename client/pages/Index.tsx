...
type Result = { detected: boolean; vegetable?: string | null; confidence?: number; message?: string };
...
export default function Index() {
  ...
  const analyze = async () => {
    ...
    try {
      ...
      setResult({ detected: false, message: error instanceof Error ? error.message : "Unable to analyze image" });
    } finally {
      setLoading(false);
    }
  };
